...
/**
 * DOESNT WORK! Adding content filters on WP ALL IMPORT 
 */
function wdbvf_on_save_post_validation_fix( $post_id, $xml, $is_update ) {
    ...
    $filtered_content_stage2 = bbc_upload_images($filtered_content_stage1, $post);
		$filtered_content_stage3 = bbc_after_pload_images($filtered_content_stage2, $post);
...
function wdbvf_single_convert_ajax() {
    ...
    $filtered_content_stage2 = bbc_upload_images($filtered_content_stage1, $post);
		$filtered_content_stage3 = bbc_after_pload_images($filtered_content_stage2);
