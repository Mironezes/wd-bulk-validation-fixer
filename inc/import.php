...
function wdbvf_on_import_post_validation_fix( $post_id, $xml, $is_update ) {
...
if( get_option('wdbvf_auto_apply_on_publication') === '0' ) {
  add_action( 'pmxi_saved_post', 'wdbvf_on_import_post_validation_fix', 10, 3 );
}
